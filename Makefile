...
deploy-sepolia :; @forge script script/DeployRaffle.s.sol:DeployRaffle --rpc-url $(SEP_RPC_URL) --account default --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv